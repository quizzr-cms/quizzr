        ...
        <div class="">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	...
                        	<form name='main' role="form" method="post"class="registration-form" action="processnewquestionsur.php" enctype="multipart/form-data">
  <h3>Question type:</h3>
...
<script src="js/custom.js"></script>
  <script src="js/pace/pace.min.js"></script>
        ...
        <script src="assets/js/scriptsur.js"></script>
