...
<body class="nav-md">
  ...
  <div class="container body">
	...
	echo '<br><form action="deletequessel.php" method="post"><input name="qn" type="hidden" value="'.$qn.'"><button class="btn btn-danger btn-m" type="submit"><i class="fa fa-trash-o"></i> Delete </button><a data-toggle="modal" data-target="#myModal" class="btn btn-info btn-m"><i class="fa fa-pencil"></i> Edit </a><a href="addquestionsel.php" class="btn btn-dark btn-m"><i class="fa fa-plus"></i> Add </a></form></center><br>';
	
	if($qn>1)
	{
		?><br><center><a class="btn btn-default" href="viewquestionssel.php?qn=<?php echo $qn-1?>"><?php echo "Previous " ?></a> <?php
	}
	$adjacents=3;
	...
	for ($i=$start;$i<=$end;$i++)
	{
		...
		?><a class="btn btn-default" href="viewquestionssel.php?qn=<?php echo $i?>"><?php echo $i." " ?></a> <?php
	}		
	if($pagecount>$qn)
	{
			?><a class="btn btn-default" href="viewquestionssel.php?qn=<?php echo $qn+1?>"><?php echo "Next " ?></a> <?php
	}
?>
</center>
<br>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       <form role="form" action="updatequestionsel.php" method="post">
