	...
	count=0;
		  ...
		  i++;
					...
					var newdiv = document.createElement('div');
          newdiv.innerHTML = "<h4>Answer</h4><div class='form-group'><input type='text' name='answer'required><br></div><input name='submit'type='submit'class='btn btn-success' value='Submit'>";
          document.getElementById('cho').appendChild(newdiv);
				 }
				 else {
					
					 var newdiv = document.createElement('div');
          newdiv.innerHTML = "<h4>Answer</h4><div class='form-group'><input type='text' name='answer' required><br></div><input type='submit' class='btn btn-success' value='Submit'>";
          document.getElementById('cho').appendChild(newdiv);
				 }
