...
<div class="nav toggle">
	...
	$sql = "SELECT * FROM surveyaccesslogs";
	...
	$sql = "SELECT * FROM surveyaccesslogs  ORDER BY time DESC LIMIT $offset,$per";
	$ref = $result->query($sql);
	...
	{
		echo "<tr><td>".$row["uid"]."</td><td>".$row["user"]."</td><td>".$row["ip"]."</td><td>".$row["time"]."</td></tr>";
	}
	?></tbody>
                  </table>
				  <center>
	...
	if($page>1)
	{
		?><a class="btn btn-default" href="accesslogssur.php?page=<?php echo $page-1?>"><?php echo "Previous " ?></a> <?php
	}
	$adjacents=7;
	...
	for ($i=$start;$i<=$end;$i++)
	{
		...
		?><a class="btn btn-default" href="accesslogssur.php?page=<?php echo $i?>"><?php echo $i." " ?></a> <?php
	}
	if($pagecount>$page)
	{
			?><a class="btn btn-default" href="accesslogssur.php?page=<?php echo $page+1?>"><?php echo "Next " ?></a> <?php
	}
?>
</div> </center>
        </div>
