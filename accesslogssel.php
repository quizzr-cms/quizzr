...
<div class="nav toggle">
	...
	$sql = "SELECT * FROM selecaccesslogs";
	...
	$sql = "SELECT * FROM selecaccesslogs  ORDER BY time DESC LIMIT $offset,$per";
	$ref = $result->query($sql);
	...
	if($page>1)
	{
		?><a class="btn btn-default" href="accesslogssel.php?page=<?php echo $page-1?>"><?php echo "Previous " ?></a> <?php
	}
	$adjacents=7;
	...
	for ($i=$start;$i<=$end;$i++)
	{
		...
		?><a class="btn btn-default" href="accesslogssel.php?page=<?php echo $i?>"><?php echo $i." " ?></a> <?php
	}
	if($pagecount>$page)
	{
			?><a class="btn btn-default" href="accesslogssel.php?page=<?php echo $page+1?>"><?php echo "Next " ?></a> <?php
	}
?>
</div> </center>
        </div>
